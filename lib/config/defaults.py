...
_C.MODEL = CN()
_C.MODEL.NAME = 'onestep_hrnet'
_C.MODEL.INIT_WEIGHTS = True
_C.MODEL.PRETRAINED = 'p'
_C.MODEL.NUM_JOINTS = 50
_C.MODEL.TARGET_TYPE = 'Gaussian'
_C.MODEL.IMAGE_SIZE = [192, 192]  # width * height
_C.MODEL.HEATMAP_SIZE = [48, 48]  # width * height
_C.MODEL.SIGMA = 1.5
_C.MODEL.EXTRA = CN()
...
_C.MODEL.EXTRA.STAGE3.NUM_MODULES = 4  # 1 
...
_C.MODEL.EXTRA.STAGE4.NUM_MODULES = 3 # 1
