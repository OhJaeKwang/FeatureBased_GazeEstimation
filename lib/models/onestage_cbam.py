...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.cbam = SABottleneck(config.MODEL.NUM_JOINTS,config.MODEL.NUM_JOINTS)
        ...
        block = blocks_dict[self.stage3_cfg['BLOCK']]    # [ 4  ,  4 ,  4] 
        ...
        block = blocks_dict[self.stage4_cfg['BLOCK']]    # [  4,  4,  4,   4]
        ...
        self.gaze_layer = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.Linear(in_features=64,out_features=2),          # 2 ,3 에 따라 버전 나뉨 pretrain은 2임 
