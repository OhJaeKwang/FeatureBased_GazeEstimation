...
class HighResolutionNet(nn.Module):
    ...
    def forward(self, x):
        ...
        key_point_xy = key_point_xy.view(key_point_xy.shape[0],100)
        
        x = self.gaze_layer(key_point_xy) # (batch,2)의 size
...
#     #print(pytorch_model_summary.summary(model, torch.zeros(1,3,192,192),show_input=True))
